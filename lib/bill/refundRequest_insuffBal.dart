...
class refundRequest_i extends StatefulWidget {
  final orderId;
  final paymentId;
  final payment;
  final productList;

  const refundRequest_i(this.orderId, this.paymentId, this.payment,this.productList );

  @override
  State<refundRequest_i> createState() => _refundRequest();
}

class _refundRequest extends State<refundRequest_i> {
  List<String> product= [];
  List<String> card=[];
  String reason= "잔액 부족";
  String errorProduct = '없음';
